...
This repository contains the primary research materials for the Law of Fairness and its scientific formulation, Per Stream Terminal Valence Closure, or PTVC.
...
PTVC turns one precise version of that question into a formal hypothesis that can be criticized, tested, narrowed, or refuted.
...
It is to make the hypothesis available for serious examination.

Read the work. Test the assumptions. Challenge the mathematics. Improve the measurements. Compare stronger rivals. Look for counterexamples.

If the framework survives scrutiny, strengthen it.

If it fails, identify exactly where and why.

Either outcome can advance the science.
